...
git remote | Создание удаленного репозитория на основе локального
git push | Перенос из локального репозитория в онлайн репозиторий
git pull | Подтянуть из онлайн репозитория в локальный